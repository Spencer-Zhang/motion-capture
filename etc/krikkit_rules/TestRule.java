...
/** 
 *	@file TestRule.java
 *	@brief This is a sample standalone testrule demonstration application to illustrate
 * 	the DMo RESTful API. The demo will first create a new rule called "testrule",
 ...
 *	PROPFIND operation/method to query for all the properties for the existing "testrule" 
 ...
 *	then perform a HTTP WebDAV DELETE operation/method to remove the rule called "testrule"
...
public class TestRule {
	...
	/**
	 *	@brief TestRule constructor initializes the default parameters.
	 */
	public TestRule(String srcIPAddr, String srcPort, 
		String destIPAddr, String destPort, 
		String contextUser, String contextPasswd, String javaKeyStore) 
		throws IOException, URISyntaxException {
		
//		srcIPAddr = '192.168.1.1';
//		srcPort = '443';
//		destIPAddr = '192.168.1.3';
//		destPort = '3000';
		...
		/* 
	 	 ...
	 	 */
		api.setAction(h, "event", "GetPayload", "5");
		...
		/*
	 	 *	Adds a new rule called "testrule".
	 	 */
		addRule(api, h);
		...
		/*
	 	 *	Performs WebDAV PROPFIND method to query for "testrule" rule.
	 	 */
		findRule(api, h);
		...
		/*
         *	Deletes an existing rule called "testrule".
         */		
//		deleteRule(api, h);
	...
	public static void main(String[] args) {
		...
		if (argsLen != MAX_CMD_LINE_ARGS 
		      || argsLen > MAX_CMD_LINE_ARGS || argsLen < MAX_CMD_LINE_ARGS) {
		      
				System.out.println("Usage: ./testrule.sh <srcIPAddr> <srcPort> <destIPAddr> <destPort> " 
					+ "<contextUser> <contextPasswd> <JavaKeyStoreFile>");
				System.out.println("Example: ./testrule.sh 10.0.2.15 8082 10.0.2.15 5001 DMRootCtx ciscoDM123 " 
					+ "/home/localadmin/krikkit/krikkit-java-api/keystore/dmkeystore.jks\n");
				System.exit(1);
		      	...
		      	try {
		      		new TestRule(args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
		      	} catch (Exception ex) {
					ex.printStackTrace();
		      	}
		}	
