...
/** 
 *	@file timerrule.java
 *	@brief This is a sample standalone timerrule demonstration application to illustrate
 * 	the DMo RESTful API. The demo will first create a new rule called "timerrule",
 ...
 *	PROPFIND operation/method to query for all the properties for the existing "timerrule" 
 ...
 *	then perform a HTTP WebDAV DELETE operation/method to remove the rule called "timerrule"
...
public class timerrule {
	...
	/**
	 *	@brief timerrule constructor initializes the default parameters.
	 */
	public timerrule() throws IOException, URISyntaxException {
		...
		/* 
	 	 ...
	 	 */
		api.setAction(h, "timer", "FETCHDATA", "1000");
...
//		api.setApplicationProtocol(h, "http");
		...
		/*
	 	 *	Adds a new rule called "timerrule".
	 	 */
		addRule(api, h);
//		
//		/* Sleeps for 1 sec. */
...
//		
//		/*
//	 	 *	Performs WebDAV PROPFIND method to query for "timerrule" rule.
//	 	 */
//		findRule(api, h);
//
//		/* Sleeps for 1 sec. */
...
//		}
		...
		/*
         *	Deletes an existing rule called "timerrule".
         */		
//		deleteRule(api, h);
