...
/** 
 *	@file lightoffrule.java
 *	@brief This is a sample standalone lightoffrule demonstration application to illustrate
 * 	the DMo RESTful API. The demo will first create a new rule called "lightoffrule",
 ...
 *	PROPFIND operation/method to query for all the properties for the existing "lightoffrule" 
 ...
 *	then perform a HTTP WebDAV DELETE operation/method to remove the rule called "lightoffrule"
...
public class lightoffrule {
	...
	/**
	 *	@brief lightoffrule constructor initializes the default parameters.
	 */
	public lightoffrule() throws IOException, URISyntaxException {
		
		String srcIPAddr = "192.168.1.1";
		String srcPort = "443";
		String destIPAddr = "192.168.1.58";
		String destPort = "80";
		...
		api.setActionEndpoint(h, "http", destIPAddr, destPort, "?mode=0&pin=9&value=0");
...
//		api.setNetFilter(h, "tcp", "", srcPort, "", "");
		...
		String thresholdTemperature = Integer.toString(celsiusToAnalog(20));
		api.findContent(h, "ANALOG.B > " + thresholdTemperature);
		
		/*
	 	 *	Adds a new rule called "lightoffrule".
	 	 */
		addRule(api, h);
...
//		}
		...
		/*
	 	 *	Performs WebDAV PROPFIND method to query for "lightoffrule" rule.
	 	 */
//		findRule(api, h);
//
//		/* Sleeps for 1 sec. */
...
//		}
		...
		/*
         *	Deletes an existing rule called "lightoffrule".
         */		
//		deleteRule(api, h);
