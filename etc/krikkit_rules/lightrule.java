...
/** 
 *	@file lightrule.java
 *	@brief This is a sample standalone lightrule demonstration application to illustrate
 * 	the DMo RESTful API. The demo will first create a new rule called "lightrule",
 ...
 *	PROPFIND operation/method to query for all the properties for the existing "lightrule" 
 ...
 *	then perform a HTTP WebDAV DELETE operation/method to remove the rule called "lightrule"
...
public class lightrule {
	...
	/**
	 *	@brief lightrule constructor initializes the default parameters.
	 */
	public lightrule() throws IOException, URISyntaxException {
		...
		api.setActionEndpoint(h, "http", destIPAddr, destPort, "?mode=0&pin=9&value=1");
...
//		api.setNetFilter(h, "tcp", "", srcPort, "", "");
		...
		/*
	 	 *	Adds a new rule called "lightrule".
	 	 */
		addRule(api, h);
...
//		}
		...
		/*
	 	 *	Performs WebDAV PROPFIND method to query for "lightrule" rule.
	 	 */
//		findRule(api, h);
//
//		/* Sleeps for 1 sec. */
...
//		}
		...
		/*
         *	Deletes an existing rule called "lightrule".
         */		
//		deleteRule(api, h);
